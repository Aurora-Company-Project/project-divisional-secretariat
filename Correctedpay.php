...
<form action="Correctedpay.php" method="post" id="CorForm">
<table > 
	<tr> <td>
<label for="owner_name"> Bill_No: </label>
	</td><td> 
...
<input type="text" id="address" name="address" /> <br/>
    ...
    <tr> <td>
<label for="arrears"> Paid Amount </label> 
</td><td>
<input type="number" id="arrears" name="arrears" /> <br/>
	</td></td></tr>
    <tr> <td>
<label for="amount"> State of Bill </label> 
</td><td>
<select name="state" > 
	<option value: "Issused"> Issued </option>
    <option value: "Canceled"> Canceled </option>
    <br/>
	</td></td></tr>
</table>
<button type="submit" form="CorPayForm" name="cancel" > Canceled payement </button>
</form>
</div>
<div id="Detail">
</div>
